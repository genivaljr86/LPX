 <div id="topo" class="centraliza">
        ...
        <div id="navigation">
	        <ul>
		        ...
		        <li><a href=""><img src="images/menu_principal/localizacao_off.png" alt="" class="botao"></a></li>
		        <li><a href=""><img src="images/menu_principal/contato_off.png" alt="" class="botao"></a></li>
	        </ul>
